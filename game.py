...
class Game():
    ...
    def start_game(self, main):
        ...
        while (not self.exit):
            ...
            main.addstr('\n')
            main.addstr("Press 'p', if you want play one more time, press 'h' to see history, or press any another key to leave\n")
            ans = main.getch()
            if ans == ord('p'):
                main.clear()
            elif ans == ord('h'):
                ...
                main.addstr('\n')
                main.addstr("Press 'p', if you want play one more time, or press any another key to leave\n")
                ans1 = main.getch()
                if ans1 == ord('p'):
                    main.clear()
                else:
    ...
    def mode(self, main, mode = 0):
        ...
        main.addstr('\n')
        self.history[self.attempt] = [self.l[self.level],self.time, self.mistakes]
        self.time = 0
        self.mistakes = 0
        main.getch()
        return
